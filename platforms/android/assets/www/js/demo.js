...
$("#camerapage").live("pagecreate", function(event) {
	...
	$("#newPicLink").live("click",function(e) {
		navigator.camera.getPicture(onSuccess, onFail, { quality: 100,  destinationType: Camera.DestinationType.DATA_URL, targetWidth: 400, targetHeight:400, correctOrientation:1});
		e.preventDefault();
	});

	$("#existingPicLink").live("click",function(e) {
		navigator.camera.getPicture(onPhotoURISuccess, onFail, { quality: 100, sourceType: Camera.PictureSourceType.PHOTOLIBRARY, targetWidth: 400, targetHeight:400, correctOrientation:1});
		e.preventDefault();
	});
